# Copyright (c) 2018, Harshit Jain <harshit@isaacchen.cn>
# THIS CODE IS SOLELY WRITTEN (COPY PASTED FROM STACK OVERFLOW)
# SO JUST TO TELL SUPRANANDA MAM THAT SHE MESSED WITH WRONG
# GUY 
...
def callback(event):
    webbrowser.open_new(r"https://www.github.com/dev-harsh1998")
...
def newuser():
    ...
    def OTP():
        try:
            ...
            mail.starttls()
            mail.login('harshitjain6751@gmail.com','nishajainlove@123321')
            mail.sendmail('harshitjain6751@gmail.com',reciver,Message)
        except:
...
link = Label(Mframe, text="Created by Anupam,Sunil,Prudhvi,Jawahar", fg="blue", cursor="hand2")
